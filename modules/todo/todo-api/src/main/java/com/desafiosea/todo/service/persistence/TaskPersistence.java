...
public interface TaskPersistence extends BasePersistence<Task> {
	 ...
	 * @return the matching tasks
	 */
	public java.util.List<Task> findByU_P(long userId, long parentTaskId);
	 ...
	 * @return the range of matching tasks
	 */
	public java.util.List<Task> findByU_P(
	 ...
	 * @return the matching tasks
	 */
	public java.util.List<Task> findByParentTaskId(long parentTaskId);
	 ...
	 * @return the range of matching tasks
	 */
	public java.util.List<Task> findByParentTaskId(
